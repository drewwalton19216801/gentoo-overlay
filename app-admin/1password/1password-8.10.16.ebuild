...
src_install() {
	...
	fperms +x /opt/${MY_PN}/op-ssh-sign
	fowners 0:onepassword /opt/${MY_PN}/${MY_PKG_HELPER}
	fowners 0:onepassword /opt/${MY_PN}/${MY_PKG_BROWSER_SUPPORT}
...
pkg_postinst() {
	...
	chmod 4755 ${EROOT}/opt/${MY_PN}/chrome-sandbox
	# The binary requires setuid so it may interact with the Kernel keyring facilities
	chmod 6755 ${EROOT}/opt/${MY_PN}/${MY_PKG_HELPER}
	chmod 2755 ${EROOT}/opt/${MY_PN}/${MY_PKG_BROWSER_SUPPORT}
